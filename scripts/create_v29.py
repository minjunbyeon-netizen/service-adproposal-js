"""V29: 배점 보강 -- 환경/타깃 분석 2장 + 매체 믹스 전략 1장 + 예산 상세 3장 (총 6장 추가)"""
import sys, os
...
# ===== #3 제안업체 일반 (4페이지) -- 사업자등록증 기반 =====
S_COMPANY = (
    '<div style="padding:var(--s-4) 0">'
    '<div class="t-caption is-accent w-bold" style="margin-bottom:var(--s-4)">COMPANY</div>'
    '<div class="t-heading" style="margin-bottom:var(--s-3)">'
    '<span class="is-accent">주식회사 하이브미디어</span></div>'
    '<div style="width:60px;height:3px;background:#E84E10;margin-bottom:var(--s-5)"></div>'
    # 2열 grid
    '<div style="display:grid;grid-template-columns:1fr 1fr;gap:0 var(--s-6);max-width:980px;margin-bottom:var(--s-5)">'
    '<div style="display:flex;align-items:baseline;gap:var(--s-3);padding:var(--s-2) 0;border-bottom:1px solid #E8E8E8">'
    '<div class="t-caption is-accent w-bold" style="width:110px;flex-shrink:0">등록번호</div>'
    '<div class="t-body is-muted">605-81-76041</div>'
    '</div>'
    '<div style="display:flex;align-items:baseline;gap:var(--s-3);padding:var(--s-2) 0;border-bottom:1px solid #E8E8E8">'
    '<div class="t-caption is-accent w-bold" style="width:110px;flex-shrink:0">대표자</div>'
    '<div class="t-body is-muted">진호진</div>'
    '</div>'
    '<div style="display:flex;align-items:baseline;gap:var(--s-3);padding:var(--s-2) 0;border-bottom:1px solid #E8E8E8">'
    '<div class="t-caption is-accent w-bold" style="width:110px;flex-shrink:0">개업일</div>'
    '<div class="t-body is-muted">20060201</div>'
    '</div>'
    '<div style="display:flex;align-items:baseline;gap:var(--s-3);padding:var(--s-2) 0;border-bottom:1px solid #E8E8E8">'
    '<div class="t-caption is-accent w-bold" style="width:110px;flex-shrink:0">법인등록</div>'
    '<div class="t-body is-muted">180111-0544593</div>'
    '</div>'
    '<div style="display:flex;align-items:baseline;gap:var(--s-3);padding:var(--s-2) 0;border-bottom:1px solid #E8E8E8">'
    '<div class="t-caption is-accent w-bold" style="width:110px;flex-shrink:0">소재지</div>'
    '<div class="t-body is-muted">부산 남구 수영로 312, 9층 918호</div>'
    '</div>'
    '<div style="display:flex;align-items:baseline;gap:var(--s-3);padding:var(--s-2) 0;border-bottom:1px solid #E8E8E8">'
    '<div class="t-caption is-accent w-bold" style="width:110px;flex-shrink:0">업태</div>'
    '<div class="t-body is-muted">서비스 / 정보통신업 / 전문, 과학 및 기술서비스업</div>'
    '</div>'
    '<div style="display:flex;align-items:baseline;gap:var(--s-3);padding:var(--s-2) 0;border-bottom:1px solid #E8E8E8">'
    '<div class="t-caption is-accent w-bold" style="width:110px;flex-shrink:0">종목</div>'
    '<div class="t-body is-muted">인터넷마케팅대행 / 광고대행 / 웹디자인 / 콘텐츠디자인</div>'
    '</div>'
    '<div style="display:flex;align-items:baseline;gap:var(--s-3);padding:var(--s-2) 0">'
    '<div class="t-caption is-accent w-bold" style="width:110px;flex-shrink:0">주요 실적</div>'
    '<div class="t-body is-muted">강서구청 구정홍보 / 부산관광공사 영상 / 영화 및 비디오물 제작</div>'
    '</div>'
    '</div>'
    '</div>'
)
...
S_PRINT = (
    "**핵심 시안: \"36%\" 중심 배치**\n\n"
    "팩트와 임팩트가 가장 강력한 '36%' 시안을 인쇄 매체 주력으로\n\n"
    "| 매체 | 시안 | 사양 |\n"
    "|------|------|------|\n"
    "| 버스쉘터 | 36% | 1200x1800mm, 양면 |\n"
    "| 지하철 역사 | 36% | 2400x1200mm |\n"
    "| 대학 내 현수막 | 36% + 슬로건 | 900x2400mm |\n"
    "| 입시요강 표지 | 36% 변형 | A4 |\n"
    "| 리플렛 | 4종 시안 종합 | 3단 접지 |\n\n"
    "숫자 '36%'의 시각적 충격을 오프라인에서 극대화\n"
    "지나가는 사람이 멈추는 광고"
)
...
S_DOCU_PLAN = (
    ...
    '· 편집: 인트로 3초 훅 + 본편 50초 + 엔딩 7초 ("지혜로운 가치를 배우는 대학, 지혜로운 당신을 만드는 대학")<br>'
...
S_FACTS = (
    ...
    '항공서비스학과 취업률 <span class="is-accent w-bold">964%</span><br>'
    'QS 호스피탈리티 부문 <span class="is-accent w-bold">글로벌 55위</span><br>'
    '호텔 총지배인 국내 최다 동문 <span class="is-accent w-bold">25명</span><br>'
    '校訓 <span class="is-accent w-bold">"지혜로운 가치를 배우는 대학, 지혜로운 당신을 만드는 대학"</span>'
    '</div>'
    '</div>'
    + script(
        '(표지가 뜬 상태에서, 인사 생략)<br><br>'
        '"영산대학교에는 이미 <strong>사실</strong>이 있습니다<br><br>'
        '항공서비스학과 취업률 964% QS 호스피탈리티 부문 글로벌 55위 '
        '호텔 총지배인 국내 최다 동문 25명 그리고 校訓 <strong>지혜로운 가치를 배우는 대학, 지혜로운 당신을 만드는 대학</strong><br><br>'
...
S_TRANSITION = (
    ...
    '<div class="t-body is-ink" style="line-height:22;text-align:left;padding:0 var(--s-2)">'
...
S_COCKTAIL = (
    ...
    '모든 대학이 이렇게 말합니다</div>'
    '<div class="t-subtitle w-regular" style="line-height:22;text-align:left;padding:0 var(--s-3)">'
    '· &nbsp;글로벌 경쟁력 1위<br>'
    '· &nbsp;최고의 교수진<br>'
    '· &nbsp;미래형 인재 양성<br>'
    '· &nbsp;4차 산업혁명 선도<br>'
...
S_METHOD_ONLY = (
    ...
    # 주황 short bar
    '<div style="width:60px;height:3px;background:#E84E10;margin:0 auto var(--s-5)"></div>'
    '<div class="t-subtitle w-regular is-muted" style="margin-bottom:var(--s-5);line-height:17">'
...
S_REFRAMING_PREVIEW = (
    ...
    '<span class="t-caption is-subtle">01</span> &nbsp;964% 취업률</div>'
    ...
    '<span class="is-accent w-bold">36%</span> 탈락률</div>'
    # 2. 국내 55위 -> 글로벌 55위
    '<div class="t-subtitle w-regular is-muted" style="text-align:right;padding:var(--s-2) var(--s-2)">'
    ...
    + script(
        ...
        '첫째, 964% 취업률이 아니라 <strong>36% 탈락률</strong><br>'
...
def sian_image_slide(ref_num, headline_a, headline_b, image_path, caption):
    return (
        ...
        f'<div class="t-title" style="text-align:center;margin-bottom:var(--s-3);line-height:125">'
...
S_SIAN_SUMMARY_V26 = (
    ...
    + _sian_row("사례 1 · 36%", SIAN_1_IMAGES)
...
S_VIDEO_INTRO = (
    ...
    '<div class="t-subtitle w-regular" style="line-height:16">정제된 한 장면<br>'
    ...
    '<div class="t-subtitle w-regular" style="line-height:16;white-space:nowrap">풀어낸 한 편의 이야기<br>'
...
S_VIDEO_WHY = (
    ...
    '<div class="t-subtitle w-regular">"지혜로운 가치를 배우는 대학, 지혜로운 당신을 만드는 대학" — 영산대학교</div>'
    '</div>'
    # 2. 영상 주인공
    '<div style="display:flex;align-items:baseline;gap:var(--s-4);padding:var(--s-2) 0;border-bottom:1px solid #E8E8E8">'
    ...
    + script(
        ...
        '<strong>첫째,</strong> 영산대 校訓이 <strong>지혜로운 가치를 배우는 대학, 지혜로운 당신을 만드는 대학</strong>입니다<br>'
...
S_EXPANSION = (
    ...
    '<div class="t-body is-muted">36% 중심 배치 (버스·지하철·현수막)</div>'
    '</div>'
    '<div style="display:flex;align-items:baseline;gap:var(--s-3);padding:var(--s-2) 0;border-bottom:1px solid #E8E8E8">'
...
S_ENVIRONMENT = (
    '<div style="padding:var(--s-4) 0;text-align:center">'
    '<div class="t-overline is-accent" style="margin-bottom:var(--s-4)">ENVIRONMENT</div>'
    '<div class="t-heading" style="margin-bottom:var(--s-3)">'
    '부울경 사립대, 같은 무대 <span class="is-accent">다른 무기</span></div>'
    '<div style="width:60px;height:3px;background:#E84E10;margin:0 auto var(--s-5)"></div>'
    # 경쟁 비교 테이블
    '<table class="t-caption w-regular is-ink" style="width:100%;max-width:1100px;margin:0 auto var(--s-4);border-collapse:collapse">'
    '<thead><tr>'
    '<th class="w-bold" style="background:#F5F5F5;padding:var(--s-1) var(--s-2);border-bottom:2px solid #E84E10;text-align:left;width:16%">대학</th>'
    '<th class="w-bold" style="background:#F5F5F5;padding:var(--s-1) var(--s-2);border-bottom:2px solid #E84E10;text-align:left;width:22%">포지셔닝</th>'
    '<th class="w-bold" style="background:#F5F5F5;padding:var(--s-1) var(--s-2);border-bottom:2px solid #E84E10;text-align:left;width:28%">광고 특징</th>'
    '<th class="w-bold is-accent" style="background:#F5F5F5;padding:var(--s-1) var(--s-2);border-bottom:2px solid #E84E10;text-align:left">영산대 차별점</th>'
    '</tr></thead><tbody>'
    '<tr><td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8"><strong>동의대</strong></td>'
    '<td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8">한의대 중심 / 전통 이미지</td>'
    '<td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8">학과 나열형 광고</td>'
    '<td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8"><strong class="is-accent">취업률 964%</strong> 숫자로 증명</td></tr>'
    '<tr><td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8"><strong>동서대</strong></td>'
    '<td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8">영상/IT 특화</td>'
    '<td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8">캠퍼스 이미지 중심</td>'
    '<td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8"><strong class="is-accent">QS 글로벌 55위</strong> 국제 공인 순위</td></tr>'
    '<tr><td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8"><strong>부경대</strong></td>'
    '<td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8">국립 / 규모 어필</td>'
    '<td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8">종합 브랜드 캠페인</td>'
    '<td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8"><strong class="is-accent">항공/호텔 특화</strong> 학과 집중</td></tr>'
    '<tr><td style="padding:var(--s-1) var(--s-2)"><strong>신라대</strong></td>'
    '<td style="padding:var(--s-1) var(--s-2)">종합대학 / 다양성</td>'
    '<td style="padding:var(--s-1) var(--s-2)">교수진/시설 나열</td>'
    '<td style="padding:var(--s-1) var(--s-2)"><strong class="is-accent">총지배인 25명</strong> 업계 실적 증명</td></tr>'
    '</tbody></table>'
    '<div class="t-caption is-muted" style="font-style:italic">'
    '— 같은 사실을 가진 대학은 없습니다 그래서 증명이 가능합니다</div>'
    '</div>'
)
...
S_TARGET = (
    '<div style="padding:var(--s-4) 0;text-align:center">'
    '<div class="t-overline is-accent" style="margin-bottom:var(--s-4)">TARGET</div>'
    '<div class="t-heading" style="margin-bottom:var(--s-3)">'
    '누구에게, 어떤 언어로 <span class="is-accent">증명</span>할 것인가</div>'
    '<div style="width:60px;height:3px;background:#E84E10;margin:0 auto var(--s-5)"></div>'
    # 3열 페르소나 카드
    '<div style="display:flex;gap:var(--s-4);max-width:1100px;margin:0 auto var(--s-4)">'
    # 수험생
    '<div style="flex:1;border:1px solid #E8E8E8;border-radius:6px;padding:var(--s-4);text-align:left">'
    '<div class="t-overline is-accent" style="margin-bottom:var(--s-2)">수험생 (17~19세)</div>'
    '<div class="t-body is-ink" style="line-height:18">'
    'SNS 헤비유저<br>15초 안에 판단<br>숫자보다 감각<br>'
    '<strong>채널:</strong> 인스타 / 틱톡 / 유튜브쇼츠</div>'
    '</div>'
    # 학부모
    '<div style="flex:1;border:1px solid #E8E8E8;border-radius:6px;padding:var(--s-4);text-align:left">'
    '<div class="t-overline is-accent" style="margin-bottom:var(--s-2)">학부모 (45~55세)</div>'
    '<div class="t-body is-ink" style="line-height:18">'
    '취업률/실적 중시<br>신문/검색 의존<br>신뢰 = 팩트<br>'
    '<strong>채널:</strong> 네이버 / 언론 / 인쇄</div>'
    '</div>'
    # 교사
    '<div style="flex:1;border:1px solid #E8E8E8;border-radius:6px;padding:var(--s-4);text-align:left">'
    '<div class="t-overline is-accent" style="margin-bottom:var(--s-2)">교사 / 진학상담사</div>'
    '<div class="t-body is-ink" style="line-height:18">'
    '입시요강 정독<br>비교 데이터 필요<br>공식자료 신뢰<br>'
    '<strong>채널:</strong> 리플렛 / 공식 홈페이지</div>'
    '</div>'
    '</div>'
    # 하단 원칙 박스
    '<div style="border-left:3px solid #E84E10;padding:var(--s-2) var(--s-4);max-width:1100px;margin:0 auto;text-align:left">'
    '<div class="t-body is-ink">'
    '수험생에게는 <strong class="is-accent">감각</strong>으로, '
    '학부모에게는 <strong class="is-accent">팩트</strong>로 — '
    '같은 증명을, 다른 언어로</div>'
    '</div>'
    '</div>'
)
...
S_MEDIA_MIX = (
    '<div style="padding:var(--s-4) 0;text-align:center">'
    '<div class="t-overline is-accent" style="margin-bottom:var(--s-4)">MEDIA MIX STRATEGY</div>'
    '<div class="t-heading" style="margin-bottom:var(--s-3)">'
    '왜 <span class="is-accent">이 조합</span>인가</div>'
    '<div style="width:60px;height:3px;background:#E84E10;margin:0 auto var(--s-4)"></div>'
    '<div class="t-body is-muted" style="margin-bottom:var(--s-4)">'
    '타깃 3그룹 x 입시 사이클 = 최소 매체 조합</div>'
    # 퍼널 테이블
    '<table class="t-caption w-regular is-ink" style="width:100%;max-width:1100px;margin:0 auto var(--s-4);border-collapse:collapse">'
    '<thead><tr>'
    '<th class="w-bold" style="background:#F5F5F5;padding:var(--s-1) var(--s-2);border-bottom:2px solid #E84E10;text-align:left;width:14%">단계</th>'
    '<th class="w-bold" style="background:#F5F5F5;padding:var(--s-1) var(--s-2);border-bottom:2px solid #E84E10;text-align:left;width:26%">매체</th>'
    '<th class="w-bold" style="background:#F5F5F5;padding:var(--s-1) var(--s-2);border-bottom:2px solid #E84E10;text-align:left;width:22%">타깃</th>'
    '<th class="w-bold" style="background:#F5F5F5;padding:var(--s-1) var(--s-2);border-bottom:2px solid #E84E10;text-align:left">핵심 메시지</th>'
    '</tr></thead><tbody>'
    '<tr><td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8"><strong class="is-accent">인지</strong></td>'
    '<td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8">인쇄 매체 + 언론</td>'
    '<td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8">학부모 / 교사</td>'
    '<td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8">36% 시안 -- 시각적 충격</td></tr>'
    '<tr><td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8"><strong class="is-accent">관심</strong></td>'
    '<td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8">유튜브 인플루언서 + 디지털 DA</td>'
    '<td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8">수험생 + 학부모</td>'
    '<td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8">리프레이밍 영상 -- 호기심 전환</td></tr>'
    '<tr><td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8"><strong class="is-accent">검토</strong></td>'
    '<td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8">SNS 이벤트 + 숏폼</td>'
    '<td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8">수험생</td>'
    '<td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8">졸업선배 리얼 콘텐츠 -- 신뢰 축적</td></tr>'
    '<tr><td style="padding:var(--s-1) var(--s-2)"><strong class="is-accent">전환</strong></td>'
    '<td style="padding:var(--s-1) var(--s-2)">홍보영상 + 입시요강</td>'
    '<td style="padding:var(--s-1) var(--s-2)">전체</td>'
    '<td style="padding:var(--s-1) var(--s-2)">"지혜" 메인 영상 -- 최종 결정</td></tr>'
    '</tbody></table>'
    '<div class="t-caption is-muted" style="font-style:italic">'
    '— 개별 매체가 아닌, 퍼널 전체를 설계합니다</div>'
    '</div>'
)

# ===== V29 신규: 매체별 예산 배분 (총 1.25억) =====
S_BUDGET_MEDIA = (
    '<div style="padding:var(--s-4) 0;text-align:center">'
    '<div class="t-overline is-accent" style="margin-bottom:var(--s-4)">BUDGET ALLOCATION</div>'
    '<div class="t-heading" style="margin-bottom:var(--s-3)">'
    '연 125억, 이렇게 <span class="is-accent">씁니다</span></div>'
    '<div style="width:60px;height:3px;background:#E84E10;margin:0 auto var(--s-5)"></div>'
    # 매체별 예산 테이블 + 비중 바
    '<table class="t-caption w-regular is-ink" style="width:100%;max-width:1100px;margin:0 auto var(--s-4);border-collapse:collapse">'
    '<thead><tr>'
    '<th class="w-bold" style="background:#F5F5F5;padding:var(--s-1) var(--s-2);border-bottom:2px solid #E84E10;text-align:left;width:30%">매체</th>'
    '<th class="w-bold" style="background:#F5F5F5;padding:var(--s-1) var(--s-2);border-bottom:2px solid #E84E10;text-align:right;width:12%">비중</th>'
    '<th class="w-bold" style="background:#F5F5F5;padding:var(--s-1) var(--s-2);border-bottom:2px solid #E84E10;text-align:right;width:14%">금액</th>'
    '<th class="w-bold" style="background:#F5F5F5;padding:var(--s-1) var(--s-2);border-bottom:2px solid #E84E10;text-align:left"></th>'
    '</tr></thead><tbody>'
    # 디지털 25%
    '<tr><td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8"><strong>디지털 광고</strong> (유튜브/인스타/페이스북 DA)</td>'
    '<td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8;text-align:right"><strong class="is-accent">25%</strong></td>'
    '<td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8;text-align:right">3,125만</td>'
    '<td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8"><div style="width:100%;height:8px;background:#F5F5F5;border-radius:4px"><div style="width:100%;height:100%;background:#E84E10;border-radius:4px"></div></div></td></tr>'
    # 홍보영상 20%
    '<tr><td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8"><strong>홍보영상 제작</strong></td>'
    '<td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8;text-align:right">20%</td>'
    '<td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8;text-align:right">2,500만</td>'
    '<td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8"><div style="width:100%;height:8px;background:#F5F5F5;border-radius:4px"><div style="width:80%;height:100%;background:#E84E10;border-radius:4px"></div></div></td></tr>'
    # 크리에이티브 시안 15%
    '<tr><td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8"><strong>크리에이티브 시안 제작</strong></td>'
    '<td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8;text-align:right">15%</td>'
    '<td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8;text-align:right">1,875만</td>'
    '<td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8"><div style="width:100%;height:8px;background:#F5F5F5;border-radius:4px"><div style="width:60%;height:100%;background:#E84E10;border-radius:4px"></div></div></td></tr>'
    # 인쇄 매체 15%
    '<tr><td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8"><strong>인쇄 매체</strong> (버스/지하철/현수막/리플렛)</td>'
    '<td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8;text-align:right">15%</td>'
    '<td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8;text-align:right">1,875만</td>'
    '<td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8"><div style="width:100%;height:8px;background:#F5F5F5;border-radius:4px"><div style="width:60%;height:100%;background:#E84E10;border-radius:4px"></div></div></td></tr>'
    # 숏폼 10%
    '<tr><td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8"><strong>숏폼 시리즈</strong> (4편)</td>'
    '<td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8;text-align:right">10%</td>'
    '<td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8;text-align:right">1,250만</td>'
    '<td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8"><div style="width:100%;height:8px;background:#F5F5F5;border-radius:4px"><div style="width:40%;height:100%;background:#E84E10;border-radius:4px"></div></div></td></tr>'
    # SNS+인플루언서 10%
    '<tr><td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8"><strong>SNS 운영 + 인플루언서</strong></td>'
    '<td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8;text-align:right">10%</td>'
    '<td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8;text-align:right">1,250만</td>'
    '<td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8"><div style="width:100%;height:8px;background:#F5F5F5;border-radius:4px"><div style="width:40%;height:100%;background:#E84E10;border-radius:4px"></div></div></td></tr>'
    # 언론 5%
    '<tr><td style="padding:var(--s-1) var(--s-2)"><strong>언론 매체</strong></td>'
    '<td style="padding:var(--s-1) var(--s-2);text-align:right">5%</td>'
    '<td style="padding:var(--s-1) var(--s-2);text-align:right">625만</td>'
    '<td style="padding:var(--s-1) var(--s-2)"><div style="width:100%;height:8px;background:#F5F5F5;border-radius:4px"><div style="width:20%;height:100%;background:#E84E10;border-radius:4px"></div></div></td></tr>'
    '</tbody></table>'
    '<div class="t-caption is-muted" style="font-style:italic">'
    '— 디지털 최대 배분: A/B 테스트 가능, 실시간 최적화 / 합계 12,500만원</div>'
    '</div>'
)
...
S_BUDGET_MONTHLY = (
    '<div style="padding:var(--s-4) 0;text-align:center">'
    '<div class="t-overline is-accent" style="margin-bottom:var(--s-4)">MONTHLY EXECUTION</div>'
    '<div class="t-heading" style="margin-bottom:var(--s-3)">'
    '수시 시즌에 <span class="is-accent">집중</span>, 나머지는 제작</div>'
    '<div style="width:60px;height:3px;background:#E84E10;margin:0 auto var(--s-5)"></div>'
    # 월별 테이블
    '<table class="t-caption w-regular is-ink" style="width:100%;max-width:1100px;margin:0 auto var(--s-4);border-collapse:collapse">'
    '<thead><tr>'
    '<th class="w-bold" style="background:#F5F5F5;padding:var(--s-1) var(--s-2);border-bottom:2px solid #E84E10;text-align:left;width:12%">월</th>'
    '<th class="w-bold" style="background:#F5F5F5;padding:var(--s-1) var(--s-2);border-bottom:2px solid #E84E10;text-align:right;width:12%">금액</th>'
    '<th class="w-bold" style="background:#F5F5F5;padding:var(--s-1) var(--s-2);border-bottom:2px solid #E84E10;text-align:right;width:8%">비중</th>'
    '<th class="w-bold" style="background:#F5F5F5;padding:var(--s-1) var(--s-2);border-bottom:2px solid #E84E10;text-align:left">핵심 활동</th>'
    '</tr></thead><tbody>'
    '<tr style="background:#FFF5F0"><td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8"><strong>5월</strong></td>'
    '<td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8;text-align:right">1,875만</td>'
    '<td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8;text-align:right"><strong class="is-accent">15%</strong></td>'
    '<td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8">수시 시작 -- 인쇄+디지털 집중 집행</td></tr>'
    '<tr style="background:#FFF5F0"><td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8"><strong>6월</strong></td>'
    '<td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8;text-align:right">2,125만</td>'
    '<td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8;text-align:right"><strong class="is-accent">17%</strong></td>'
    '<td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8">원서 접수 전 -- 최대 노출 (언론+DA 풀가동)</td></tr>'
    '<tr style="background:#FFF5F0"><td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8"><strong>7월</strong></td>'
    '<td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8;text-align:right">1,375만</td>'
    '<td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8;text-align:right"><strong class="is-accent">11%</strong></td>'
    '<td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8">수시 마감 -- 마지막 부스트</td></tr>'
    '<tr><td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8">4월</td>'
    '<td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8;text-align:right">625만</td>'
    '<td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8;text-align:right">5%</td>'
    '<td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8">기획 / 킥오프 / 시안 제작</td></tr>'
    '<tr><td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8">8~9월</td>'
    '<td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8;text-align:right">1,500만</td>'
    '<td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8;text-align:right">12%</td>'
    '<td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8">성과 분석 / 숏폼 제작 / 정시 사전 인지</td></tr>'
    '<tr><td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8">10~11월</td>'
    '<td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8;text-align:right">1,875만</td>'
    '<td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8;text-align:right">15%</td>'
    '<td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8">정시 집중 -- 디지털+숏폼 공개</td></tr>'
    '<tr><td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8">12월</td>'
    '<td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8;text-align:right">750만</td>'
    '<td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8;text-align:right">6%</td>'
    '<td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8">정시 마감 / 연간 결산</td></tr>'
    '<tr><td style="padding:var(--s-1) var(--s-2)">1~3월</td>'
    '<td style="padding:var(--s-1) var(--s-2);text-align:right">2,375만</td>'
    '<td style="padding:var(--s-1) var(--s-2);text-align:right">19%</td>'
    '<td style="padding:var(--s-1) var(--s-2)">Year2 수립 / 시안 리뉴얼 / 영상 제작</td></tr>'
    '</tbody></table>'
    # 요약 박스
    '<div style="border-left:3px solid #E84E10;padding:var(--s-2) var(--s-4);max-width:1100px;margin:0 auto;text-align:left">'
    '<div class="t-body is-ink">'
    '<strong class="is-accent">수시 (5~7월) 43%</strong> 집중 / '
    '정시 (10~11월) 15% / '
    '제작+분석 42%</div>'
    '</div>'
    '</div>'
...
S_BUDGET_ROI = (
    '<div style="padding:var(--s-4) 0;text-align:center">'
    '<div class="t-overline is-accent" style="margin-bottom:var(--s-4)">COST EFFICIENCY</div>'
    '<div class="t-heading" style="margin-bottom:var(--s-3)">'
    '1억 2천 5백만 원의 <span class="is-accent">가치</span></div>'
    '<div style="width:60px;height:3px;background:#E84E10;margin:0 auto var(--s-5)"></div>'
    # KPI 테이블
    '<table class="t-caption w-regular is-ink" style="width:100%;max-width:1100px;margin:0 auto var(--s-4);border-collapse:collapse">'
    '<thead><tr>'
    '<th class="w-bold" style="background:#F5F5F5;padding:var(--s-1) var(--s-2);border-bottom:2px solid #E84E10;text-align:left;width:22%">매체</th>'
    '<th class="w-bold" style="background:#F5F5F5;padding:var(--s-1) var(--s-2);border-bottom:2px solid #E84E10;text-align:right;width:18%">예상 성과</th>'
    '<th class="w-bold" style="background:#F5F5F5;padding:var(--s-1) var(--s-2);border-bottom:2px solid #E84E10;text-align:right;width:18%">단가</th>'
    '<th class="w-bold" style="background:#F5F5F5;padding:var(--s-1) var(--s-2);border-bottom:2px solid #E84E10;text-align:right;width:18%">업계 평균</th>'
    '<th class="w-bold is-accent" style="background:#F5F5F5;padding:var(--s-1) var(--s-2);border-bottom:2px solid #E84E10;text-align:right">절감률</th>'
    '</tr></thead><tbody>'
    '<tr><td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8"><strong>디지털 DA</strong></td>'
    '<td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8;text-align:right">노출 200만회</td>'
    '<td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8;text-align:right">CPM 1,563원</td>'
    '<td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8;text-align:right">CPM 2,500원</td>'
    '<td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8;text-align:right"><strong class="is-accent">-37%</strong></td></tr>'
    '<tr><td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8"><strong>유튜브 프리롤</strong></td>'
    '<td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8;text-align:right">완시청 5만회</td>'
    '<td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8;text-align:right">CPCV 625원</td>'
    '<td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8;text-align:right">CPCV 900원</td>'
    '<td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8;text-align:right"><strong class="is-accent">-31%</strong></td></tr>'
    '<tr><td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8"><strong>인쇄 매체</strong></td>'
    '<td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8;text-align:right">일 유동 5만 x 180일</td>'
    '<td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8;text-align:right">일 10,417원</td>'
    '<td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8;text-align:right">—</td>'
    '<td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8;text-align:right">—</td></tr>'
    '<tr><td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8"><strong>숏폼 4편</strong></td>'
    '<td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8;text-align:right">합산 조회 45만</td>'
    '<td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8;text-align:right">편당 313만</td>'
    '<td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8;text-align:right">편당 500만</td>'
    '<td style="padding:var(--s-1) var(--s-2);border-bottom:1px solid #E8E8E8;text-align:right"><strong class="is-accent">-37%</strong></td></tr>'
    '<tr><td style="padding:var(--s-1) var(--s-2)"><strong>SNS 운영</strong></td>'
    '<td style="padding:var(--s-1) var(--s-2);text-align:right">팔로워 +6,000명</td>'
    '<td style="padding:var(--s-1) var(--s-2);text-align:right">팔로워당 208원</td>'
    '<td style="padding:var(--s-1) var(--s-2);text-align:right">팔로워당 350원</td>'
    '<td style="padding:var(--s-1) var(--s-2);text-align:right"><strong class="is-accent">-41%</strong></td></tr>'
    '</tbody></table>'
    '<div class="t-caption is-muted" style="font-style:italic">'
    '— 같은 예산으로, 더 많이 보여드리겠습니다</div>'
    '</div>'
)
...
S_ENDING = (
    ...
    '<div class="t-subtitle w-regular is-muted" style="line-height:24">'
...
def make_sections():
    ...
    # 자동 인덱싱 -- order_idx를 enumerate로 부여
    raw = [
        # I. 제안개요
        (2, "", parent(P_I) + S_FACTS),
        (2, "", parent(P_I) + S_PROBLEM),
        # V29 신규: 환경/타깃 분석 (I. 제안개요 내)
        (2, "환경 분석", parent(P_I) + tag("경쟁 환경") + S_ENVIRONMENT),
        (2, "타깃 분석", parent(P_I) + tag("페르소나") + S_TARGET),
        # II 제안업체 일반
        (2, "제안업체 일반", parent(P_II) + S_COMPANY),
        # III 세부 과업 수행 계획 (간지)
        (1, "세부 과업 수행 계획", None),

        # III 1 - 소재 발굴 및 콘텐츠 기획
        (2, T_SOURCE, parent(P_III) + tag("인식의 한계") + S_NUMBERS),
        (2, T_SOURCE, parent(P_III) + tag("차별화의 부재") + S_TRANSITION),
        (2, T_SOURCE, parent(P_III) + tag("소음") + S_LOSS),
        (2, T_SOURCE, parent(P_III) + tag("접근법") + S_BRIDGE),
        (2, T_SOURCE, parent(P_III) + tag("컨셉") + S_CONCEPT_ONLY),
        (2, T_SOURCE, parent(P_III) + tag("기법") + S_METHOD_ONLY),
        (2, T_SOURCE, parent(P_III) + tag("프리뷰") + S_REFRAMING_PREVIEW),
        (2, T_SOURCE, parent(P_III) + tag("사례 1-1") + sian_image_fullscreen("1-1", "964%", "36%", SIAN_1_IMAGES[0], "")),
        (2, T_SOURCE, parent(P_III) + tag("사례 1-2") + sian_image_fullscreen("1-2", "964%", "36%", SIAN_1_IMAGES[1], "")),
        (2, T_SOURCE, parent(P_III) + tag("사례 1-3") + sian_image_fullscreen("1-3", "964%", "36%", SIAN_1_IMAGES[2], "")),
        (2, T_SOURCE, parent(P_III) + tag("사례 2-1") + sian_image_fullscreen("2-1", "국내 우수 호스피탈리티", "글로벌 55위 영산대", SIAN_2_IMAGES[0], "")),
        (2, T_SOURCE, parent(P_III) + tag("사례 2-2") + sian_image_fullscreen("2-2", "국내 우수 호스피탈리티", "글로벌 55위 영산대", SIAN_2_IMAGES[1], "")),
        (2, T_SOURCE, parent(P_III) + tag("사례 2-3") + sian_image_fullscreen("2-3", "국내 우수 호스피탈리티", "글로벌 55위 영산대", SIAN_2_IMAGES[2], "")),
        (2, T_SOURCE, parent(P_III) + tag("사례 3-1") + sian_image_fullscreen("3-1", "25명의 총지배인", "25개 호텔 · 하나의 대학", SIAN_3_IMAGES[0], "")),
        (2, T_SOURCE, parent(P_III) + tag("사례 3-2") + sian_image_fullscreen("3-2", "25명의 총지배인", "25개 호텔 · 하나의 대학", SIAN_3_IMAGES[1], "")),
        (2, T_SOURCE, parent(P_III) + tag("사례 3-3") + sian_image_fullscreen("3-3", "25명의 총지배인", "25개 호텔 · 하나의 대학", SIAN_3_IMAGES[2], "")),
        (2, T_SOURCE, parent(P_III) + tag("사례 3-4") + sian_image_fullscreen("3-4", "25명의 총지배인", "25개 호텔 · 하나의 대학", SIAN_3_IMAGES[3], "")),
        (2, T_SOURCE, parent(P_III) + tag("사례 3-5") + sian_image_fullscreen("3-5", "25명의 총지배인", "25개 호텔 · 하나의 대학", SIAN_3_IMAGES[4], "")),
        (2, T_SOURCE, parent(P_III) + tag("사례 3-6") + sian_image_fullscreen("3-6", "25명의 총지배인", "25개 호텔 · 하나의 대학", SIAN_3_IMAGES[5], "")),
        (2, T_SOURCE, parent(P_III) + tag("종합") + S_SIAN_SUMMARY_V26),

        # 대학 공식 홍보영상
        (1, "대학 공식 홍보영상", None),
        (2, T_VIDEO, parent(P_III) + tag("영상 접근법") + S_VIDEO_INTRO),
        (2, T_VIDEO, parent(P_III) + tag("주인공") + S_VIDEO_WHY),
        (2, T_VIDEO, parent(P_III) + tag("본편") + S_JIHYE),
        (2, T_VIDEO, parent(P_III) + tag("영상 2") + S_JIHYE_2),
        (2, T_VIDEO, parent(P_III) + tag("영상 3") + S_JIHYE_3),

        # 실무 확장 대시보드
        (2, T_SOURCE, parent(P_III) + tag("확장 개요") + S_EXPANSION),
        # V29 신규: 매체 믹스 전략
        (2, T_SOURCE, parent(P_III) + tag("매체 전략") + S_MEDIA_MIX),

        # 매체 전개
        (2, T_YOUTUBE, parent(P_III) + tag("인플루언서") + S_YOUTUBE_V22),
        (2, T_PRINT, parent(P_III) + tag("인쇄 매체") + S_PRINT),
        (2, T_DIGITAL, parent(P_III) + tag("디지털 매체") + S_DIGITAL),
        (2, T_VIDEO, parent(P_III) + tag("숏폼 기획") + S_DOCU_PLAN),
        (2, T_VIDEO, parent(P_III) + tag("숏폼 완성본") + S_DOCU_VIDEOS),
        (2, T_SNS, parent(P_III) + tag("소셜 미디어") + S_SNS),
        (2, T_PRESS, parent(P_III) + tag("언론 매체") + S_PRESS),
        (2, T_MGMT, parent(P_III) + tag("운영 지원") + S_CONSULT),

        # IV 사업 관리 계획
        (2, T_IV_1, parent(P_IV) + tag("일정 계획") + S_GANTT),
        # V29 신규: 예산 상세 3장
        (2, T_IV_1, parent(P_IV) + tag("매체별 예산") + S_BUDGET_MEDIA),
        (2, T_IV_1, parent(P_IV) + tag("월별 집행") + S_BUDGET_MONTHLY),
        (2, T_IV_1, parent(P_IV) + tag("비용 효율") + S_BUDGET_ROI),
        (2, T_IV_2, parent(P_IV) + tag("성과 측정") + S_FEEDBACK),
        (2, T_IV_3, parent(P_IV) + tag("확장 계획") + S_OPERATION),

        # 마무리는 템플릿의 slide-end가 담당
    ]
    return [(lv, t, i + 1, c) for i, (lv, t, c) in enumerate(raw)]
...
if __name__ == "__main__":
    ...
    cur = conn.execute(
        ...
        ("V29", "V29", "ready", RFP, SUMMARY, SUMMARY, "A"))
    pid = cur.lastrowid

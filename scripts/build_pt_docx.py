...
def build_scenario(doc=None, do_save=True):
    ...
    add_table(
        ...
        [
            ...
            ["P41 Influencer Review", "1:00", "21:45", "CPE 320원 — 업계 평균 600~1,200원의 절반 이하"],
            ...
            ["P52 Monthly Execution", "0:20", "26:45", "'수시 9~11월 집중 + 정시 11월~2월 디지털 잔여 노출'"],
        ],
        col_widths=[3.5, 1.5, 1.5, 9.8],
    )
    ...
    emphases = [
        {
            ...
            "ment": [
                ...
                "'55 — QS 호스피탈리티 분야 세계 55위.'",
                "'03 — 한국 호텔관광 TOP 3.'",
                "'이 숫자들은 영산대학교가 이미 갖고 있는 것들입니다. 광고가 발명하는 게 아닙니다. 꺼내는 겁니다.'",
            ],
            "q": "'세계 8위라는 근거가 무엇입니까?'",
            "a": "THE Impact Rankings 2024 기준입니다. UN SDGs 달성 기여도 평가 지표로, 연구 영향력 항목에서 국내 1위입니다. 슬라이드 하단에 출처 각주를 명시했고, 모든 광고 소재에도 동일한 출처 표기를 의무화하겠습니다.",
        },
        {
            "no": "2",
        ...
        },
        {
            ...
            "a": "P48 관리 계획에 명시되어 있습니다. 모집인원 대비 지원배수, 원서 접수 전환율, 브랜드 서베이 인지도, 채널별 CPE — 네 가지 지표를 월별로 보고드립니다. 숫자로 시작했으니 숫자로 결과를 보여드리겠습니다. 분기마다 평가회를 통해 미달성 항목은 다음 분기에 공식 보완 계획서로 제출하겠습니다.",
        },
    ]
    ...
    qas = [
        ...
        },
        {
            ...
            "a": [
                ...
                "영산대 호텔관광 동문회 협조 하에 졸업생 현직자 크리에이터를 우선 검토하여 진행 — 광고가 아니라 경험담.",
        ...
        {
            "q": "Q11. 수시 9~11월 집중 외에 정시(12~2월) 광고는 어떻게 운영합니까?",
            "a": [
                "정시 11월부터 2월까지 디지털 DA·SNS 잔여 노출로 지속 집행합니다.",
                "수시 합격자 발표 후 미합격 수험생을 대상으로 영산대 정시 모집 광고를 노출합니다.",
                "정시 매체 단가는 수시 대비 약 30% 저렴 — 동일 예산으로 디지털 효율이 더 높아집니다.",
                "총 예산 1.25억의 약 15%(1,900만 원)를 정시 시즌 별도 편성합니다.",
            ],
        },
    ]
...
def build_cheatsheet(doc=None, do_save=True):
    ...
    add_table(
        ...
        [
            ...
            ["정시 시즌 광고", "Q11 → '11~2월 디지털 잔여 노출. 1.25억의 15%(1,900만) 별도 편성'"],
...
def build_memorize(doc=None, do_save=True, out_name="04_암기카드_첫90초_마지막90초.docx"):
    ...
    add_para(doc, "'08 연구력 세계 8위 국내 1위. 25 호텔 총지배인 25명. 55 QS 호스피탈리티 세계 55위. 03 한국 호텔관광 TOP 3.'", size=11, indent=0.5)
...
def build_crisis(doc=None, do_save=True):
    ...
    add_bullet(doc, "P53 본문도 압축: '0825503. 수험생·학부모·유학생. 감사합니다.'")
